...
import {removeProjectOfTextField} from '../../state/mySurveys/createNewSetOfQuestions'

class TrashIcon extends React.Component {
    render() {
        return (<svg width="26" height="26" onClick={() => this.props._removeProjectOfTextField(this.props.keyValue)}        >
...
const mapDispatchToProps = dispatch => ({
    _removeProjectOfTextField: (key) => dispatch(removeProjectOfTextField(key))
})
